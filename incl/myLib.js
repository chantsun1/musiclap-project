...
(function(){
	...
	// To send an action to the process-ui.php over AJAX
	myLib.post3 = function(param, successCallback) {
        param = param || {};
        myLib.processJSON('process-ui.php?rnd=' + new Date().getTime(), param, successCallback, {method:'POST'});
	}
